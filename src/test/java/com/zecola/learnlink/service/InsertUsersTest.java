...
import com.zecola.learnlink.model.domain.User;import org.junit.jupiter.api.Test;
    ...
    public void doConcurrencyInsertUsers() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            while (true) {
                j++;
                User user = new User();
                user.setUsername("colaaaa");
                user.setUserAccount("aaaaaaaa");
                user.setAvatarUrl("https://cdn.xykcola.site/blogPics/post/202405/202405271602052.png");
                user.setGender(0);
                user.setUserPassword("12345678");
                user.setPhone("123");
