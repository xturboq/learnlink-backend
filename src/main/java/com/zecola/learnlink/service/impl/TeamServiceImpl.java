...
import com.zecola.learnlink.model.vo.UserVO;
...
import static com.zecola.learnlink.constant.Constant.REDISSON_LOCK_JOIN_TEAM;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team> implements TeamService {
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock(REDISSON_LOCK_JOIN_TEAM);
        try {
            // 抢到锁并执行
            while (true) {
