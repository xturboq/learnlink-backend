...
import com.zecola.learnlink.utils.AlgorithmUtils;
...
import static com.zecola.learnlink.constant.UserConstant.ADMIN_ROLE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    /**
     * 从HttpServletRequest中获取当前登录的用户信息。
     * @param request HttpServletRequest对象，用于访问会话和其他请求相关信息。
     * @return 当前登录的User对象，如果用户未登录或者请求对象为空，则返回null。
     */
    @Override
