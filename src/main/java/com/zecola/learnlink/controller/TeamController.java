...
import com.zecola.learnlink.common.DeleteRequest;
...
import com.zecola.learnlink.model.request.TeamAddRequest;
...
public class TeamController {
    ...
    public BaseResponse<Boolean> deleteTeam(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        if (!result) {
            throw new BusinessException(ErrorCode.SYSTEM_EXCEPTION, "删除失败");
        }
    ...
    public BaseResponse<Boolean> updateTeam(@RequestBody TeamUpdateRequest teamUpdateRequest, HttpServletRequest request) {
        ...
        if (!result) {
            throw new BusinessException(ErrorCode.SYSTEM_EXCEPTION, "更新失败");
        }
        return ResultUtils.success(true);
    }
     ...
     * 分页查询团队信息
     *
     * @param teamQuery 团队查询条件，包含分页信息和团队属性
     * @return 基于分页的团队列表响应对象
     * @throws BusinessException 如果teamQuery为null，抛出业务异常，表示参数错误
     */
    ...
    public BaseResponse<Page<Team>> listTeamsByPage(TeamQuery teamQuery) {
        ...
        // 创建查询包装器，将Team对象作为查询条件
        QueryWrapper<Team> queryWrapper = new QueryWrapper<>(team);
        // 调用团队服务的page方法，进行分页查询，并返回查询结果
        Page<Team> resultPage = teamService.page(page, queryWrapper);
        // 构建并返回查询成功的响应对象，包含分页的团队列表
